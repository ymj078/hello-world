...
public class LogginAspect {
	...
	public void before(JoinPoint joinPoint){
		...
		for(Object org:joinPoint.getArgs()){
			System.out.println("@Before [" +signatureString+ "] 아규먼트"+ org);
		}
	}
	...
	public void afterThrowing(JoinPoint joinPoint, Throwable ex){
		String signatureString = joinPoint.getSignature().getName();
		System.out.println("@AfterThrowing [" +signatureString+ "] 메서드 실행 예외 수행");
		System.out.println("@AfterThrowing [" +signatureString+ "] 예외메세지: "+ ex.getMessage());		
	}
